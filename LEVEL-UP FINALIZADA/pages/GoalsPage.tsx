    ...
    <div className="space-y-8 pb-10">
      ...
      <div className="bg-gradient-to-r from-purple-700 to-purple-500 rounded-2xl p-8 text-white flex justify-between items-center">
        <div>
          ...
          <p className="text-white/80">Defina e acompanhe seus objetivos</p>
        </div>
        <button 
      ...
      <div className="grid gap-6">
        {goals.length === 0 ? (
          <div className="text-center py-20 bg-white rounded-2xl shadow-sm">
            ...
            <p className="text-purple-200 text-lg">Nenhuma meta criada ainda</p>
            <p className="text-purple-200 mt-1">Comece definindo seus objetivos!</p>
          </div>
        ) : goals.map(goal => {
                ...
                <div className="flex-1 w-full">
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      ...
                      <div className="flex items-center gap-4 text-sm text-purple-200 mt-2">
                        <span className="flex items-center gap-1">
                          <Calendar size={14} />
                          Até {new Date(goal.endDate).toLocaleDateString('pt-BR')}
                        </span>
                        {timeLeft > 0 && (
                          <span className="text-purple-600 font-semibold">{timeLeft} dias restantes</span>
                        )}
                      </div>
                    </div>
                  ...
                  {updateGoalId === goal.id ? (
                    <div className="flex items-center gap-2 bg-purple-50 p-2 rounded-lg border border-purple-100 w-full md:w-auto">
                      <input 
                        ...
                        className="flex-1 md:w-20 bg-transparent text-lg font-bold outline-none border-b border-purple-300 focus:border-purple-500"
                        placeholder="0"
                      />
                      <span className="text-sm text-purple-200">{goal.unit}</span>
                      <button 
