  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-gradient-to-r from-purple-900 to-purple-800 rounded-2xl p-8 text-white">
          <h1 className="text-4xl font-bold mb-2 text-purple-50">Bem-vindo de volta!</h1>
        ...
        <div className="bg-white rounded-2xl p-8 shadow-lg">
          ...
          <div className="flex justify-center gap-6 text-sm mt-6 flex-wrap">
              ...
              <div key={d.name} className="flex items-center gap-2">
                ...
                <span className="text-purple-900 font-medium">{d.name} ({d.value})</span>
              </div>
            ))}
          </div>
        </div>
              ...
              return (
                <div key={goal.id}>
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className="text-sm font-bold text-purple-600 bg-purple-50 px-3 py-1 rounded-full">{percentage}%</span>
                  </div>
                  ...
                  <p className="text-xs text-purple-200 mt-1">{new Date(goal.endDate).toLocaleDateString('pt-BR')}</p>
                </div>
              );
            })}
            {goals.length === 0 && (
