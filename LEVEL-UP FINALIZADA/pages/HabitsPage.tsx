      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {habits.length === 0 ? (
          <div className="col-span-full text-center py-20 bg-white rounded-2xl shadow-sm">
            ...
            <p className="text-purple-300 text-lg font-semibold">Nenhum hábito criado ainda</p>
            <p className="text-purple-300 mt-1">Comece criando novos hábitos!</p>
          </div>
        ) : habits.map(habit => {
              ...
              >
                ...
                <div className="pr-20">
                  <h3 className={`font-bold text-lg ${
                    isDoneToday ? 'text-purple-700 line-through' : 'text-purple-900'
                  }`}>
                    {habit.title}
                  </h3>
                </div>
        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center p-4 z-50 backdrop-blur-sm">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-8">
            ...
            <form onSubmit={handleHabitSubmit} className="space-y-5">
              <div>
                <label className="block text-sm font-semibold text-purple-700 mb-2">Nome do Hábito</label>
                <input 
                  autoFocus
                  required
                  type="text" 
